...
export function Hero() {
  return (
    <section className="bg-[linear-gradient(135deg,_#F3FBF6_0%,_#E8F7EF_50%,_#F6FBF8_100%)]">
      <Container>
        <div className="grid items-center gap-12 py-28 lg:grid-cols-2 lg:py-32">
          ...
          <div className="relative mx-auto w-full max-w-xl">
            <div className="relative mx-auto h-[560px] w-full max-w-[520px] sm:h-[600px]">
              <PhoneMockup className="absolute left-1/2 top-1/2 aspect-[10/19] w-[240px] -translate-x-[60%] -translate-y-[55%] -rotate-2 sm:w-[260px]">
                <img
                  src="./images/hero-feed.png"
                  alt="Radius feed screen"
                  className="h-[103%] w-full -translate-y-[3%] object-cover object-top"
                  width={450}
                  height={900}
                  loading="eager"
                />
              </PhoneMockup>
              <PhoneMockup className="absolute left-1/2 top-1/2 aspect-[10/19] w-[240px] -translate-x-[5%] -translate-y-[45%] rotate-2 sm:w-[260px]">
                <img
